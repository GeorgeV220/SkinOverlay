...
public class PlayerListeners {
    ...
    public void onLogin(ClientConnectionEvent.Join joinEvent) {
        if (!joinEvent.getTargetEntity().isOnline())
            return;
        final PlayerObject playerObject = new PlayerObjectSponge7(joinEvent.getTargetEntity());
    ...
    public void onLogin(ClientConnectionEvent.Disconnect disconnectEvent) {
        final PlayerObject playerObject = new PlayerObjectSponge7(disconnectEvent.getTargetEntity());
        final UserData userData = UserData.getUser(playerObject);
