...
public class GameProfileProvider_1_21_R5 extends GameProfileProvider {
    @Override
    ...
    public SGameProfile getGameProfile(@NotNull SPlayer player) {
        ...
        gameProfile.getProperties().forEach((s, property) -> propertyObjectMap
                .append(s, new SProperty(property.name(), property.value(), property.signature())));
